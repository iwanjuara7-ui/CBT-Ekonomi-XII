...
import { Question, SubmissionRecord, ExamSettings } from '../types';
...
import { 
  ...
  Users, Eye, X, Filter, School, Check, RotateCcw, SlidersHorizontal, 
...
export const TeacherDashboard: React.FC<TeacherDashboardProps> = ({
  ...
  // Settings state for KKM and Duration configuration
  ...
  }, [examSettings.kkm, examSettings.durationMinutes]);
  ...
  const handleSaveSettings = (e?: React.FormEvent) => {
    ...
    setSettingsMessage(`Pengaturan berhasil disimpan! KKM: ${cleanKkm}, Durasi: ${cleanDuration} Menit.`);
  ...
  const handleResetSettings = () => {
    ...
    setKkmInput(75);
    setDurationInput(30);
    setSettingsMessage('Pengaturan dikembalikan ke standar awal (KKM 75 & Durasi 30 Menit).');
    setTimeout(() => setSettingsMessage(null), 4000);
  };
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
        {activeTab === 'recap' ? (
          ...
          <section id="settings-view" className="space-y-6 pb-12">
            ...
            {/* CARD 3: Database Eksternal Google Spreadsheet & Apps Script */}
